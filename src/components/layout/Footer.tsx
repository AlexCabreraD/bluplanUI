...
export default function Footer() {
  return (
    <footer
      style={{ backgroundColor: "rgba(15, 20, 37, 1)" }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li>
                  <Link
                    href="/"
                    className="text-gray-300 hover:text-[#009ce0] transition-colors duration-200 block py-1 text-sm sm:text-base"
                  >
                    Home
                  </Link>
                </li>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex gap-2 sm:gap-3">
                <a
                  href="#"
                  className="w-10 h-10 sm:w-12 sm:h-12 bg-[#1877F2] rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-200"
                >
                  <svg
                    width="18"
                    height="18"
                ...
                <a
                  href="#"
                  className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-tr from-[#FEDA75] via-[#FA7E1E] to-[#D62976] rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-200"
                >
                  <svg
                    width="16"
                    height="16"
                ...
                <a
                  href="#"
                  className="w-10 h-10 sm:w-12 sm:h-12 bg-black rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-200"
                >
                  <svg
                    width="16"
                    height="16"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
            <div className="flex flex-col sm:flex-row lg:flex-row justify-between items-center gap-3 sm:gap-4">
              <p className="text-gray-400 text-xs sm:text-sm text-center sm:text-left">
                © 2025 BluPlan Studio. All rights reserved.
              </p>
              <div className="flex flex-wrap justify-center sm:justify-end gap-3 sm:gap-6 text-xs sm:text-sm">
                <a
                  href="#"
                  className="text-gray-400 hover:text-[#009ce0] transition-colors duration-200"
                >
                  Privacy Policy
                </a>
                <a
