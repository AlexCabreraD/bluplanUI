...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = "primary", size = "md", children, disabled, loading, className, ...props }, ref) => {
    const baseClasses =
    ...
    const variantClasses = {
      primary: "bg-[#009ce0] text-white hover:bg-[#007bb5] focus:ring-[#009ce0]",
      secondary: "bg-gray-100 text-gray-900 hover:bg-gray-200 focus:ring-gray-500",
      outline:
        "bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#009ce0] focus:ring-white",
    };
